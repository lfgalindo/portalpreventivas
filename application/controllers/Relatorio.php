...
class Relatorio extends CI_Controller {
	...
	public function index() {
		...
		// $fields = array( 'id_tim', 'operadora', 'rede', 'tipo_ne', 'fornecedor', 'ne_id', 'cidade', 'estado', 'endereco', 'bairro', 'cm' );
		...
		$this->template->load('template.php', 'relatorios/index-view.php', $dados);
